...
export class LeaveTypeController {
  ...
  async create(@Body() createLeaveTypeDto: CreateLeaveTypeDto): Promise<LeaveTypeResponseDto> {
    ...
    return new LeaveTypeResponseDto(leaveType);
  }
  ...
  async findAll(): Promise<LeaveTypeResponseDto[]> {
    ...
    return leaveTypes.map(leaveType => new LeaveTypeResponseDto(leaveType));
  }
  ...
  async update(
    ...
    return new LeaveTypeResponseDto(updatedLeaveType);
  }
