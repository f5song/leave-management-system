...
export class RoleController {
  ...
  async findOne(@Param() param: ValidateParamRoleId): Promise<ResponseObject<RoleResponseDto>> {
    ...
    return {
      code: HttpStatus.OK,
      message: 'SUCCESS',
      data: this.roleService.toRoleResponseDto(role),
    };
  }
  ...
  // @ApiOkResponse({ type: RoleResponseDto })
  // async update(@Param() param: ValidateParamRoleId, @Body() updateRoleDto: UpdateRoleDto): Promise<ResponseObject<RoleResponseDto>> {
  //   const updatedRole = await this.roleService.update(param.id, updateRoleDto);
  //   return {
  //     code: HttpStatus.OK,
  //     message: 'SUCCESS',
  //     data: this.roleService.toRoleResponseDto(updatedRole),
  //   };
  // }
  ...
  // @RolesPermission({ role: [ERole.ADMIN], permissions: [EPermission.UPDATE_ROLE] })
  // @ApiOkResponse({ type: RoleResponseDto })
  // async partialUpdate(@Param() param: ValidateParamRoleId, @Body() updateRoleDto: UpdateRoleDto): Promise<ResponseObject<RoleResponseDto>> {
  //   const updatedRole = await this.roleService.update(param.id, updateRoleDto);
  //   return {
  //     code: HttpStatus.OK,
  //     message: 'SUCCESS',
